...
<section class="content">
    ...
    <div class="col-sm-4">
        <select name="tcat_id" class="form-control select2 top-cat" id="top-category">
    ...
    <div class="col-sm-4">
        <select name="ecat_id" class="form-control select2 end-cat" id="end-category">
...
<script>
    $(document).ready(function () {
        $('#top-category').change(function () {
            ...
            if (topCategoryId !== '') {
                $.ajax({
                    url: 'get_mid_categories.php', // Replace with the URL of your PHP script to fetch mid-level categories
                    type: 'post',
                    ...
                    success: function (response) {
                        ...
                        if (len > 0) {
                            for (var i = 0; i < len; i++) {
                                var ecatId = response[i]['ecat_id'];
                                var ecatName = response[i]['ecat_name'];
                                $("#end-category").append("<option value='" + ecatId + "'>" + ecatName + "</option>");
                            }
                        }
                    }
                });
                ...
                $("#end-category").empty();
                $("#end-category").append("<option value=''>Select End Level Category</option>");
            }
        });
    });
</script>
