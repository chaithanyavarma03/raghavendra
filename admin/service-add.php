...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $statement = $pdo->prepare("INSERT INTO tbl_service (title, content, photo, button_url) VALUES (?, ?, ?, ?)");
        $statement->execute(array($_POST['title'], $_POST['content'], $final_name, $_POST['button_url']));
