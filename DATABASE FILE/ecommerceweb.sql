...
INSERT INTO `tbl_service` (`id`, `title`, `content`, `photo` ,'button_text','button_url') VALUES
(5, 'Easy Returns', 'Return any item before 15 days!', 'service-5.png','View Women Accessories', 'product-category.php?id=4&type=mid-category'),
(6, 'Free Shipping', 'Enjoy free shipping inside US.', 'service-6.png','View Women Accessories', 'product-category.php?id=4&type=mid-category'),
(7, 'Fast Shipping', 'Items are shipped within 24 hours.', 'service-7.png','View Women Accessories', 'product-category.php?id=4&type=mid-category'),
(8, 'Satisfaction Guarantee', 'We guarantee you with our quality satisfaction.', 'service-8.png','View Women Accessories', 'product-category.php?id=4&type=mid-category'),
(9, 'Secure Checkout', 'Providing Secure Checkout Options for all', 'service-9.png','View Women Accessories', 'product-category.php?id=4&type=mid-category'),
(10, 'Money Back Guarantee', 'Offer money back guarantee on our products', 'service-10.png','View Women Accessories', 'product-category.php?id=4&type=mid-category');
