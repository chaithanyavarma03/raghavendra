...
?>
				...
				<div class="product">
					<div class="row">
						...
						<div class="col-md-7">
							<div class="p-title" ><h2 style="color: Black;"><?php echo $p_name; ?></h2></div>
							<div class="p-review">
								<div class="rating">
                                    <?php
                                    if($avg_rating == 0) {
...
<div class="product bg-grays pt_70 pb_70" style="background-color:#5a2e2b; ">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    <h2 style="color:aliceblue;"><?php echo LANG_VALUE_155; ?></h2>
                    <h3 style="color:aliceblue;"><?php echo LANG_VALUE_156; ?></h3>
                </div>
            </div>
        </div>
        <div class="row">
