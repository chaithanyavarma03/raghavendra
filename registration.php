...
if (isset($_POST['form1'])) {
    ...
    $verify_link ='http://localhost/RTS/RTS/verify.php?email='.$to.'&token='.$token;
...
//try {
   ...
   // $mail->Username   = 'rtshopingdotcom@gmail.com';                 //SMTP username
   // $mail->Password   = 'fvpmhdzuhiihowuj';                    //SMTP password
...
$mail->SMTPAuth = true;
$mail->Username = 'rtshopingdotcom@gmail.com'; // Replace with your actual data
$mail->Password = 'fvpmhdzuhiihowuj'; // Replace with your actual password or app password
...
$mail->setFrom('rtshopingdotcom@gmail.com', 'RTS shop');
...
try {
    ...
    echo "Message could not be sent. Mailer Error: {$mail->ErrorInfo}";
	error_log("Verification email sending failed: " . $mail->ErrorInfo);
}
...
<div class="background-wrap">
        <video id="video-bg-elem" preload="auto" autoplay="true" loop="loop" muted="muted">
            <source src="/RTS/RTS/assets/uploads/demo.mp4" type="video/mp4">
        </video>
    </div>
<style>
    body, html {
...
.content {
    ...
    /* Add your other styling for content */
}
</style>
