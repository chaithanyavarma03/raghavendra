...
// Default values or condition checks for undefined variables
$before_head = isset($before_head) ? $before_head : '';
$after_body = isset($after_body) ? $after_body : '';
$contact_phone = isset($contact_phone) ? $contact_phone : '+919014200295';
$contact_email = isset($contact_email) ? $contact_email : 'email@example.com';
	...
	<div class="container">
		<div class="row inner">
			<div class="col-md-4 logo">
				<a href="index.php"><img src="assets/uploads/logo.png"<?php echo $logo; ?>" alt="logo image"></a>
			</div>
				...
				<div class="menu-container">
					<div class="menu">
						<ul>
							...
							foreach ($result as $row) {
								?>
								<li><a &type=top-category"><?php echo $row['tcat_name']; ?></a>
									<ul>
										<?php
