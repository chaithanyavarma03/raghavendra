        ...
        <div class="row">            
            <div class="col-md-12">
                ...
                <div class="row cform">
                    ...
                    <div class="col-md-4">
                        <legend style="color: Black;"><span class="glyphicon glyphicon-globe"></span> Our office</legend>
                        <address style="color: Black;">
                            <?php
                            if (isset($contact_address)) {
                                echo nl2br($contact_address);
                            } else {
                                echo 'Contact address not available.';
                            }
                            ?>
                        </address>
                        <address>
                            <strong style="color: Black;">Phone:</strong><br>
                            <span style="color: Black;"><?php echo $contact_phone; ?></span>
                        </address>
                        <address>
                            <strong style="color: Black;">Email:</strong><br>
                            <a  style="color: Black;" href="mailto:<?php echo $contact_email; ?>"><span style="color: Black;"><?php echo $contact_email; ?></span></a>
                        </address>
                    </div>
                </div>

                <h3 style="color: Black;">Find Us On Map</h3>
