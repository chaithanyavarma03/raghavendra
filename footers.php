...
foreach ($result as $row)
{
	...
	// Ensure footer copyright is defined. If it's part of the loop, it's already defined.
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 copyright">
				<?php echo $footer_copyright = isset($footer_copyright) ? $footer_copyright : 'Copyright © Your Company Name. All rights reserved.'; ?>
